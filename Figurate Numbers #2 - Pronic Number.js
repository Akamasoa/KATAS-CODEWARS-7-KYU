/*
Description:
< PREVIOUS KATA NEXT KATA >

#Task: You have to create a function isPronic to check whether the argument passed is a Pronic Number and return true if it is & false otherwise.
